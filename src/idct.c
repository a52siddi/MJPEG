...
////	cl_kernel brev = NULL;
////
////	brev = clCreateKernel(program, "IDCT_1Dim", &ret);
////
////    size_t globalSize= 8;
//
//
...
//		}
//
////		ret = clSetKernelArg(brev, 0, sizeof(cl_mem), &Y(k,0));
//
//
////	    ret = clEnqueueNDRangeKernel(queue, brev, 1, NULL, globalSize, 0, NULL, NULL);
//
//		idct_1d(&Y(k, 0));
//
//	}
